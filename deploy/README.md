...
- Serveur accessible en SSH (idéalement via un réseau privé / VPN).
...
- Réseau : le batch n'écoute sur aucun port ; l'accès distant éventuel se fera via un réseau privé.
